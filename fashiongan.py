...
D = StandardProjectionDiscriminator(input_size=(1,32,32),num_classes=10,apply_sigmoid=False)
...
learner = RHingeGanLearner(G,D)

if __name__ == "__main__":
    learner.train(dataset,gen_optimizer=g_optim,disc_optimizer=d_optim,num_classes=10,model_dir="./fashion-gan",latent_size=128,batch_log=False)
